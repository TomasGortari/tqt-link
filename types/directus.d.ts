export type Ad = {
  ...
  export type ArticlesCategories = {
    date_created?: string | null;
    date_updated?: string | null;
    description?: string | null;
    icon?: string | null;
  ...
  export type Products = {
    ...
    category?: number | ProductsCategories | null;
    date_created?: string | null;
    date_updated?: string | null;
    id: number;
    image?: string | DirectusFiles | null;
  ...
  export type Videos = {
    ...
    products: any[] | VideosProducts[];
    status: string;
    thumb?: string | DirectusFiles | null;
    tiktok_link?: string | null;
    title?: string | null;
    youtube_link?: string | null;
  };
  
  export type VideosProducts = {
    id: number;
    products_id?: number | Products | null;
    videos_id?: number | Videos | null;
  };
  ...
  export type CustomDirectusTypes = {
    ...
    tc: Tc;
    videos: Videos[];
    videos_products: VideosProducts[];
    websites: Websites[];
  };
